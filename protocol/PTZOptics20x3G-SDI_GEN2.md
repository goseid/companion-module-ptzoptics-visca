...
| Gain                  | Direct             | 81 01 04 4C 00 00 0p 0q FF           | pq: Gain Position (0x00=0 ~ 0x07=7)                                                                                     |
...
| Exp_Bright            | Direct             | 81 01 04 4D 00 00 0p 0q FF           | pq: Exposure Bright Position (0x00=0 ~ 0x11=17)                                                                         |
| CAM_Backlight         | On                 | 81 01 04 33 02 FF                    | Back Light Compensation On                                                                                              |
...
| CAM_NR2DLevel         | Level              | 81 01 04 53 0p FF                    | p: 2D NR Level (0=Off, 1=Weak through 5=Strong). Not in official documentation; verified working.                       |
| CAM_NR3DLevel         | Level              | 81 01 04 54 0p FF                    | p: 3D NR Level (0=Off, 1 through 5). OSD allows up to 8 but VISCA clamps at 5. Not in official documentation; verified. |
...
| Pan Tilt Drive        | Absolute Position  | 81 01 06 02 VV WW Y Y Y Y Z Z Z Z FF | VV: Pan Speed 0x01 (Low) to 0x18 (high) WW: Tilt Speed 0x01 (Low) to 0x18 (high) YYYY: Pan Position ZZZZ: Tilt Position |
| Pan Tilt Drive        | Relative Position  | 81 01 06 03 VV WW Y Y Y Y Z Z Z Z FF | VV: Pan Speed 0x01 (Low) to 0x18 (high) WW: Tilt Speed 0x01 (Low) to 0x18 (high) YYYY: Pan Position ZZZZ: Tilt Position |
...
| ------------------------ | ----------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CAM_PowerInq             | 81 09 04 00 FF    | 90 50 0p FF                      | p: 2=On, 3=Off (standby), 4=Internal Power Circuit Error                                                                                                     |
...
| CAM_GainPosInq           | 81 09 04 4C FF    | 90 50 00 00 0p 0q FF             | pq: Gain Position. Not in official documentation; verified to match CameraBlockInq gain value.                                                               |
...
| CAM_Noise2DLevelInq      | 81 09 04 53 FF    | 90 50 0p FF                      | Noise Reduction (2D) p: 0 to 5                                                                                                                               |
| CAM_Noise3DLevelInq      | 81 09 04 54 FF    | 90 50 0p FF                      | Noise Reduction (3D) p: 0 to 8                                                                                                                               |
...
| CAM_GainLimitInq         | 81 09 04 2C FF    | 90 50 0p FF                      | p: Gain Limit                                                                                                                                                |
| CAM_DHotPixelInq         | 81 09 04 56 FF    | 90 50 0p FF                      | p: Dynamic Hot Pixel Setting (0: Off, level 1 to 6)                                                                                                          |
...
| CAM_AFZoneInq            | 81 09 04 AA FF    | 90 50 0p FF                      | p: 0=Top, 1=Center, 2=Bottom                                                                                                                                 |
