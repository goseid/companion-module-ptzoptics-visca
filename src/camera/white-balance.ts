...
export const RGainReset = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x03, 0x00, 0xff])
export const RGainUp = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x03, 0x02, 0xff])
export const RGainDown = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x03, 0x03, 0xff])

export const RGainDirect = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x43, 0x00, 0x00, 0x00, 0x00, 0xff], {
	gain: {
		nibbles: [13, 15],
	},
})

export const BGainReset = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x04, 0x00, 0xff])
export const BGainUp = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x04, 0x02, 0xff])
export const BGainDown = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x04, 0x03, 0xff])

export const BGainDirect = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x44, 0x00, 0x00, 0x00, 0x00, 0xff], {
	gain: {
		nibbles: [13, 15],
	},
})
