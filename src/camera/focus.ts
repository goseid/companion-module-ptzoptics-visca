...
export const FocusNearVariable = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x08, 0x30, 0xff], {
	speed: { nibbles: [9] },
})

export const FocusFarVariable = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x08, 0x20, 0xff], {
	speed: { nibbles: [9] },
})

export const FocusDirect = new ModuleDefinedCommand([0x81, 0x01, 0x04, 0x48, 0x00, 0x00, 0x00, 0x00, 0xff], {
	position: {
		nibbles: [9, 11, 13, 15],
	},
})
